...
import shaded.org.apache.commons.collections4.OrderedMap;
import shaded.org.apache.commons.collections4.OrderedMapIterator;
import shaded.org.apache.commons.collections4.ResettableIterator;
import shaded.org.apache.commons.collections4.iterators.AbstractUntypedIteratorDecorator;
import shaded.org.apache.commons.collections4.keyvalue.AbstractMapEntry;
import shaded.org.apache.commons.collections4.list.UnmodifiableList;
...
public class ListOrderedMap<K, V>
    ...
    static class ValuesView<V> extends AbstractList<V> {
        ...
        public Iterator<V> iterator() {
            return new AbstractUntypedIteratorDecorator<Entry<Object, V>, V>(parent.entrySet().iterator()) {
                public V next() {
    ...
    static class KeySetView<K> extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new AbstractUntypedIteratorDecorator<Entry<K, Object>, K>(parent.entrySet().iterator()) {
                public K next() {
    ...
    static class EntrySetView<K, V> extends AbstractSet<Entry<K, V>> {
        ...
        public boolean remove(final Object obj) {
            ...
            if (getEntrySet().contains(obj)) {
                final Object key = ((Entry<K, V>) obj).getKey();
                parent.remove(key);
                return true;
            }
            return false;
