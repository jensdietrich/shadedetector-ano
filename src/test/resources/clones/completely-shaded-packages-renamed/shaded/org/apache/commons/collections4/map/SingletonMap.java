...
import shaded.org.apache.commons.collections4.iterators.SingletonIterator;
...
public class SingletonMap<K, V>
     ...
     */
    public SingletonMap(final Entry<? extends K, ? extends V> mapEntry) {
        super();
    ...
    public Set<Entry<K, V>> entrySet() {
        final Entry<K, V> entry = new TiedMapEntry<K, V>(this, getKey());
    ...
    public boolean equals(final Object obj) {
        ...
        final Entry<?,?> entry = other.entrySet().iterator().next();
