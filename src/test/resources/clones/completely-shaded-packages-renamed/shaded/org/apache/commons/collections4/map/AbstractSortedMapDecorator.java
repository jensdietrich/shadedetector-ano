...
import shaded.org.apache.commons.collections4.IterableSortedMap;
import shaded.org.apache.commons.collections4.OrderedMapIterator;
import shaded.org.apache.commons.collections4.iterators.ListIteratorWrapper;
...
public abstract class AbstractSortedMapDecorator<K, V> extends AbstractMapDecorator<K, V> implements
    ...
    protected static class SortedMapIterator<K, V> extends EntrySetToMapIteratorAdapter<K, V>
        ...
        public synchronized void reset() {
            super.reset();
            iterator = new ListIteratorWrapper<Entry<K, V>>(iterator);
        }
        ...
        public boolean hasPrevious() {
            return ((ListIterator<Entry<K, V>>) iterator).hasPrevious();
        }
         ...
         */
        public K previous() {
            entry = ((ListIterator<Entry<K, V>>) iterator).previous();
            return getKey();
        }
    }
}
