...
import shaded.org.apache.commons.collections4.iterators.EmptyIterator;
import shaded.org.apache.commons.collections4.iterators.IteratorChain;
import shaded.org.apache.commons.collections4.iterators.LazyIteratorChain;
import shaded.org.apache.commons.collections4.iterators.TransformIterator;
...
//        }
    ...
    public boolean containsValue(final Object value) {
        final Set<Entry<K, Object>> pairs = decorated().entrySet();
        if (pairs != null) {
    ...
    public void putAll(final Map<? extends K, ?> map) {
        if (map instanceof MultiMap) {
            for (final Entry<? extends K, Object> entry : ((MultiMap<? extends K, V>) map).entrySet()) {
                putAll(entry.getKey(), (Collection<V>) entry.getValue());
            }
        } else {
            for (final Entry<? extends K, ?> entry : map.entrySet()) {
