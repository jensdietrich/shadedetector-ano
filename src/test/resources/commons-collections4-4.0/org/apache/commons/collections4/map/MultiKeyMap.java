...
public class MultiKeyMap<K, V> extends AbstractMapDecorator<MultiKey<? extends K>, V>
     ...
     * @since 4.0
     */
    public static <K, V> MultiKeyMap<K, V> multiKeyMap(final org.apache.commons.collections4.map.AbstractHashedMap<MultiKey<? extends K>, V> map) {
        if (map == null) {
     ...
     * {@link #multiKeyMap(org.apache.commons.collections4.map.AbstractHashedMap)}.
     * The map must not be null and should be empty or only contain valid keys.
     * This constructor performs no validation.
     *
     * @param map  the map to decorate
     */
    protected MultiKeyMap(final org.apache.commons.collections4.map.AbstractHashedMap<MultiKey<? extends K>, V> map) {
        super(map);
        this.map = map;
    }
    ...
    public V get(final Object key1, final Object key2) {
        ...
        org.apache.commons.collections4.map.AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry =
    ...
    public V put(final K key1, final K key2, final V value) {
        ...
        org.apache.commons.collections4.map.AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry = decorated().data[index];
        while (entry != null) {
            if (entry.hashCode == hashCode && isEqualKey(entry, key1, key2)) {
    ...
    public V removeMultiKey(final Object key1, final Object key2) {
        ...
        final int index = decorated().hashIndex(hashCode, decorated().data.length);
        org.apache.commons.collections4.map.AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry = decorated().data[index];
        org.apache.commons.collections4.map.AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> previous = null;
        while (entry != null) {
            if (entry.hashCode == hashCode && isEqualKey(entry, key1, key2)) {
                final V oldValue = entry.getValue();
     ...
     */
    protected boolean isEqualKey(final org.apache.commons.collections4.map.AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry,
     ...
     */
    @Override
    protected org.apache.commons.collections4.map.AbstractHashedMap<MultiKey<? extends K>, V> decorated() {
