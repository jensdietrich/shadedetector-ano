 ...
 * by the {@link org.apache.commons.collections4.sequence.SequencesComparator SequencesComparator} class. The user can
 * walk through it using the <em>visitor</em> design pattern.
 * <p>
 * It is guaranteed that the objects embedded in the {@link org.apache.commons.collections4.sequence.InsertCommand insert
 * commands} come from the second sequence and that the objects embedded in
 * either the {@link org.apache.commons.collections4.sequence.DeleteCommand delete commands} or {@link KeepCommand keep
 ...
 * @see EditCommand
 * @see org.apache.commons.collections4.sequence.CommandVisitor
...
public class EditScript<T> {
     ...
     * @param command  command to add
     */
    public void append(final org.apache.commons.collections4.sequence.InsertCommand<T> command) {
        commands.add(command);
        ++modifications;
    }
     ...
     * @param command  command to add
     */
    public void append(final org.apache.commons.collections4.sequence.DeleteCommand<T> command) {
        commands.add(command);
        ++modifications;
    }
