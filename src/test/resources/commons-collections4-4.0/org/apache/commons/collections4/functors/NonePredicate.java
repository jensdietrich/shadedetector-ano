...
public final class NonePredicate<T> extends AbstractQuantifierPredicate<T> {
    ...
    public static <T> Predicate<T> nonePredicate(final Predicate<? super T>... predicates) {
        ...
        return new NonePredicate<T>(org.apache.commons.collections4.functors.FunctorUtils.copy(predicates));
    }
    ...
    public static <T> Predicate<T> nonePredicate(final Collection<? extends Predicate<T>> predicates) {
        final Predicate<? super T>[] preds = org.apache.commons.collections4.functors.FunctorUtils.validate(predicates);
        if (preds.length == 0) {
