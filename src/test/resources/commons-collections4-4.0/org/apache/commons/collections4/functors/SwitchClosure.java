...
public class SwitchClosure<E> implements Closure<E>, Serializable {
    ...
    private SwitchClosure(final boolean clone, final Predicate<? super E>[] predicates,
        ...
        super();
        iPredicates = clone ? org.apache.commons.collections4.functors.FunctorUtils.copy(predicates) : predicates;
        iClosures = clone ? org.apache.commons.collections4.functors.FunctorUtils.copy(closures) : closures;
    ...
    public Predicate<? super E>[] getPredicates() {
        return org.apache.commons.collections4.functors.FunctorUtils.<E>copy(iPredicates);
    }
    ...
    public Closure<? super E>[] getClosures() {
        return org.apache.commons.collections4.functors.FunctorUtils.<E>copy(iClosures);
    }
