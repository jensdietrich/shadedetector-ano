...
abstract class AbstractPatriciaTrie<K, V> extends AbstractBitwiseTrie<K, V> {
    ...
    protected AbstractPatriciaTrie(final org.apache.commons.collections4.trie.KeyAnalyzer<? super K> keyAnalyzer) {
        super(keyAnalyzer);
    }

    /**
     * Constructs a new {@link org.apache.commons.collections4.Trie Trie} using the given
     * {@link org.apache.commons.collections4.trie.KeyAnalyzer} and initializes the {@link org.apache.commons.collections4.Trie Trie}
    ...
    public V put(final K key, final V value) {
        ...
        if (!org.apache.commons.collections4.trie.KeyAnalyzer.isOutOfBoundsIndex(bitIndex)) {
            if (org.apache.commons.collections4.trie.KeyAnalyzer.isValidBitIndex(bitIndex)) { // in 99.999...9% the case
                /* NEW KEY+VALUE TUPLE */
                final TrieEntry<K, V> t = new TrieEntry<K, V>(key, value, bitIndex);
                addEntry(t, lengthInBits);
                incrementSize();
                return null;
            } else if (org.apache.commons.collections4.trie.KeyAnalyzer.isNullBitKey(bitIndex)) {
            ...
            } else if (org.apache.commons.collections4.trie.KeyAnalyzer.isEqualBitKey(bitIndex)) {
