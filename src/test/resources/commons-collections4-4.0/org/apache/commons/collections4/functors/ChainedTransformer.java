...
public class ChainedTransformer<T> implements Transformer<T, T>, Serializable {
    ...
    private ChainedTransformer(final boolean clone, final Transformer<? super T, ? extends T>[] transformers) {
        super();
        iTransformers = clone ? org.apache.commons.collections4.functors.FunctorUtils.copy(transformers) : transformers;
    }
    ...
    public Transformer<? super T, ? extends T>[] getTransformers() {
        return org.apache.commons.collections4.functors.FunctorUtils.<T, T>copy(iTransformers);
    }
