...
public class TransformerUtils {
     ...
     */
    public static <T> Transformer<T, Boolean> asTransformer(final org.apache.commons.collections4.Predicate<? super T> predicate) {
    ...
    public static <I, O> Transformer<I, O> switchTransformer(final org.apache.commons.collections4.Predicate<? super I> predicate,
            final Transformer<? super I, ? extends O> trueTransformer,
            final Transformer<? super I, ? extends O> falseTransformer) {
        return SwitchTransformer.switchTransformer(new org.apache.commons.collections4.Predicate[] { predicate },
     ...
     * @see SwitchTransformer
     */
    public static <I, O> Transformer<I, O> switchTransformer(final org.apache.commons.collections4.Predicate<? super I>[] predicates,
    ...
    public static <I, O> Transformer<I, O> switchTransformer(
            final Map<org.apache.commons.collections4.Predicate<I>, Transformer<I, O>> predicatesAndTransformers) {
    ...
    public static <I, O> Transformer<I, O> switchMapTransformer(
        ...
        final org.apache.commons.collections4.Predicate<I>[] preds = new Predicate[size];
        int i = 0;
